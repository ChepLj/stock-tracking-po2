...
import { chevronUpCircle, codeDownloadOutline, colorPalette, createOutline, globe, handRightOutline } from "ionicons/icons";
    ...
    <>
        ...
        <TableVirtuoso
          ...
          fixedHeaderContent={() => (
            <tr style={{ background: "red", color: "white" }}>
              ...
              <th style={{ padding: "5px 10px", border: "2px solid #ccc", fontSize: "12px" }}>Inbound Date</th>
      ...
      <IonFab slot="fixed" vertical="bottom" horizontal="end">
          ...
          <IonFabList side="top">
            ...
            <IonFabButton>
              <IonIcon icon={handRightOutline} onClick={()=>setIsModalOpen({isOpen: true, value: ''})}></IonIcon>
            </IonFabButton>
            <IonFabButton>
